 ...
 */
public class YearsDiff extends ScalarFunction implements BinaryExpression, ExplicitlyCastableSignature,
     ...
     */
    public YearsDiff(Expression arg0, Expression arg1) {
        super("years_diff", arg0, arg1);
    }
     ...
     */
    @Override
    public YearsDiff withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new YearsDiff(children.get(0), children.get(1));
    }
