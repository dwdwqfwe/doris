...
/**
 * ScalarFunction 'jsonb_parse_nullable'. This class is generated by GenerateFunction.
 */
public class JsonbParseNullable extends ScalarFunction
     ...
     */
    public JsonbParseNullable(Expression arg) {
        super("jsonb_parse_nullable", arg);
    }
     ...
     */
    @Override
    public JsonbParseNullable withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1);
        return new JsonbParseNullable(children.get(0));
    }
